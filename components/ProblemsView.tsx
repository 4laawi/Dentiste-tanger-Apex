    ...
    <div className="pt-0">
      ...
      <section id="problems-section" className="pt-16 pb-0 bg-white overflow-hidden">
        <div className="container mx-auto px-4 text-center mb-8">
          <h2 className="text-3xl md:text-5xl lg:text-[69px] font-work font-bold text-black leading-[1.1] lowercase mb-0 mt-[79px]">
            {t.problems.title_bold}
          </h2>
          <h3 className="text-2xl md:text-3xl lg:text-[39px] font-work font-light text-black opacity-80 lowercase leading-[1.1]">
      ...
      <ScheduleBanner t={t.schedule_banner} />
