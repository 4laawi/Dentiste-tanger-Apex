        ...
        <div className="flex flex-col md:flex-row md:items-start gap-6 lg:gap-8">
          ...
          >
            <div className="flex flex-row items-baseline gap-3 md:gap-4 flex-wrap">
              {/* "plus de" / "more" */}
              <h2 className="text-4xl md:text-6xl lg:text-[80px] font-work font-black leading-[0.85] text-black whitespace-nowrap">
                {t.title_bold}
              </h2>

              {/* "problèmes dentaires" / "dental problems" */}
              <h3 className="text-3xl md:text-4xl lg:text-5xl font-work font-light leading-[1] text-black/80">
                {t.title_light}
              </h3>
            </div>
