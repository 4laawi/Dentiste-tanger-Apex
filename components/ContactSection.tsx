            ...
            <div className="space-y-10">
              ...
              <div className="flex gap-6 items-start group">
                <div className="shrink-0 w-10 h-10 flex items-center justify-center">
                  <MapPin className="text-brand-cyan" size={36} strokeWidth={1.5} aria-hidden="true" />
                </div>
                <div className="text-white text-xl md:text-2xl font-sans leading-snug">
                  <p>{ADDRESS}</p>
                  <a href="https://www.google.com/maps/search/?api=1&query=Apex+Dental+Clinic+Tanger" target="_blank" rel="noopener noreferrer" className="text-brand-cyan font-bold text-lg border-b border-brand-cyan hover:text-white hover:border-white transition-all mt-2 inline-block">
                    {t.directions}
                  </a>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex gap-6 items-start">
                  <div className="shrink-0 w-10 h-10 flex items-center justify-center">
                    <Phone className="text-brand-cyan" size={32} strokeWidth={1.5} aria-hidden="true" />
                  </div>
                ...
                <div className="flex gap-6 items-start">
                  <div className="shrink-0 w-10 h-10 flex items-center justify-center">
                    <svg viewBox="0 0 24 24" className="text-brand-cyan w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              <div className="flex gap-6 items-start">
                <div className="shrink-0 w-10 h-10 flex items-center justify-center">
                  <Clock className="text-brand-cyan" size={32} strokeWidth={1.5} aria-hidden="true" />
                </div>
